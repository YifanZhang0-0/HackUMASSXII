...
# 2 "./unicall.h" 2
# 1 "././unicall_functions.h" 1
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h" 1 3 4
# 2 "././unicall_functions.h" 2
...
struct fancy_return_type _unique_func_7(void* data){ float retval = square ( *((int *)decode_request_data(&data, "int")) ); return encode_return_data((void *)&retval, "float"); } const char * _unique_arr_7[] = {"int"}; int _unique_7 = append_to_manifest( "square", "float", _unique_arr_7, sizeof(_unique_arr_7) / sizeof(size_t), &_unique_func_7 );
