...
# 64 "/usr/include/c++/11/memory" 2 3
...
# 65 "/usr/include/c++/11/memory" 2 3
...
# 66 "/usr/include/c++/11/memory" 2 3
...
# 68 "/usr/include/c++/11/memory" 2 3
...
# 37 "/usr/include/c++/11/bits/align.h" 2 3
...
# 74 "/usr/include/c++/11/memory" 2 3


# 1 "/usr/include/c++/11/bits/unique_ptr.h" 1 3
# 36 "/usr/include/c++/11/bits/unique_ptr.h" 3
...
# 37 "/usr/include/c++/11/bits/unique_ptr.h" 2 3
...
# 38 "/usr/include/c++/11/bits/unique_ptr.h" 2 3
...
# 39 "/usr/include/c++/11/bits/unique_ptr.h" 2 3
...
# 40 "/usr/include/c++/11/bits/unique_ptr.h" 2 3
...
# 52 "/usr/include/c++/11/bits/shared_ptr.h" 3
...
# 53 "/usr/include/c++/11/bits/shared_ptr.h" 2 3
# 1 "/usr/include/c++/11/bits/shared_ptr_base.h" 1 3
# 52 "/usr/include/c++/11/bits/shared_ptr_base.h" 3
...
#pragma GCC visibility pop
# 53 "/usr/include/c++/11/bits/shared_ptr_base.h" 2 3
...
# 58 "/usr/include/c++/11/bits/shared_ptr_base.h" 2 3
...
# 62 "/usr/include/c++/11/bits/shared_ptr_base.h" 2 3
...
# 35 "/usr/include/c++/11/ext/concurrence.h" 2 3
...
# 161 "/usr/include/c++/11/bits/atomic_base.h" 3
  template<typename _Tp>
    struct atomic;
...
# 184 "/usr/include/c++/11/bits/atomic_base.h" 3
  extern "C" {
...
# 268 "/usr/include/c++/11/bits/atomic_base.h" 3
    inline __attribute__((__always_inline__)) void
...
# 323 "/usr/include/c++/11/bits/atomic_base.h" 3
...
# 615 "/usr/include/c++/11/bits/atomic_base.h" 3
      inline __attribute__((__always_inline__)) __int_type
...
# 896 "/usr/include/c++/11/bits/atomic_base.h" 3
      inline __attribute__((__always_inline__)) __pointer_type
...
# 1921 "/usr/include/c++/11/bits/atomic_base.h" 3
...
# 13 "/usr/include/c++/11/pstl/glue_memory_defs.h" 3
...
# 14 "/usr/include/c++/11/pstl/glue_memory_defs.h" 2 3
...
# 2 "././onedef_functions.hpp" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h" 1 3 4
# 3 "././onedef_functions.hpp" 2
...
# 8 "././onedef_functions.hpp" 2


# 9 "././onedef_functions.hpp"
...
void handle_request(int socket){
  ...
  while((head - buffer) < length){
    ...
    fflush(
# 117 "././onedef_functions.hpp" 3 4
          stdout
# 117 "././onedef_functions.hpp"
                );
    fflush(
# 118 "././onedef_functions.hpp" 3 4
          stderr
# 118 "././onedef_functions.hpp"
                );
    unsigned long value;
    switch(head[0]){
      case 0xA1:{
  ...
  fflush(
# 176 "././onedef_functions.hpp" 3 4
        stdout
# 176 "././onedef_functions.hpp"
              );
  fflush(
# 177 "././onedef_functions.hpp" 3 4
        stderr
# 177 "././onedef_functions.hpp"
              );
  printf("function id: %d", function_id);
  fflush(
# 179 "././onedef_functions.hpp" 3 4
        stdout
# 179 "././onedef_functions.hpp"
              );
  fflush(
# 180 "././onedef_functions.hpp" 3 4
        stderr
# 180 "././onedef_functions.hpp"
              );
  ...
  fflush(
# 226 "././onedef_functions.hpp" 3 4
        stdout
# 226 "././onedef_functions.hpp"
              );
  fflush(
# 227 "././onedef_functions.hpp" 3 4
        stderr
# 227 "././onedef_functions.hpp"
              );
}
...
void server_init(char *socket_location){
 ...
 if( (sock = socket(
# 235 "././onedef_functions.hpp" 3 4
                   1
# 235 "././onedef_functions.hpp"
                          , 
# 235 "././onedef_functions.hpp" 3 4
                            SOCK_STREAM
# 235 "././onedef_functions.hpp"
 ...
 remote.sun_family = 
# 241 "././onedef_functions.hpp" 3 4
                    1
# 241 "././onedef_functions.hpp"
                           ;
...
# 3 "./onedef_macros.hpp" 2
# 33 "./onedef_macros.hpp"
...
struct fancy_return_type _unique_func_12(std::vector<char*> args){ int i = 0; auto retval = square ( *((long *)(args[i++])) ); return encode_return_data((void *)(new auto(retval)), "double"); } const char * _unique_arr_12[] = {"long"}; int _unique_12 = append_to_manifest( "square", "double", _unique_arr_12, sizeof(_unique_arr_12) / sizeof(size_t), &_unique_func_12 );
struct fancy_return_type _unique_func_13(std::vector<char*> args){ int i = 0; auto retval = mul ( *((long *)(args[i++])) , *((long *)(args[i++])) ); return encode_return_data((void *)(new auto(retval)), "double"); } const char * _unique_arr_13[] = {"long" , "long"}; int _unique_13 = append_to_manifest( "mul", "double", _unique_arr_13, sizeof(_unique_arr_13) / sizeof(size_t), &_unique_func_13 );
